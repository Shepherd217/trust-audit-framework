...
export default function WaitlistForm() {
  ...
  return (
    <div className="min-h-screen bg-[#050507] text-[#EAECF0] flex items-center justify-center p-6">
      <motion.div
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-semibold text-[#EAECF0] mb-2">JOIN PHASE 1 WAITLIST</h2>
