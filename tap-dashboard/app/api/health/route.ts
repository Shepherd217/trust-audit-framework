...
export async function GET(request: NextRequest) {
  ...
  if (!detailed && !metrics) {
    try {
      ...
      return NextResponse.json({ status: 'ok', version: '0.19.6', latest_sdk_version: '0.19.6', latest_python_version: '1.2.6', min_supported_version: '0.19.0', timestamp: new Date().toISOString() }, {
        status: 200,
        headers: {
