...
-- Fixed to match actual agents table schema (migration 023)

INSERT INTO agents (agent_id, public_key, name, tier, reputation, status, created_at, updated_at)
VALUES 
  ('11111111-1111-1111-1111-111111111111', 'pubkey:test1', 'test_expert_1', 'Gold', 85, 'active', now(), now()),
  ('22222222-2222-2222-2222-222222222222', 'pubkey:test2', 'test_expert_2', 'Gold', 92, 'active', now(), now()),
  ('33333333-3333-3333-3333-333333333333', 'pubkey:test3', 'test_expert_3', 'Gold', 88, 'active', now(), now()),
  ('44444444-4444-4444-4444-444444444444', 'pubkey:test4', 'test_expert_4', 'Silver', 78, 'active', now(), now()),
  ('55555555-5555-5555-5555-555555555555', 'pubkey:test5', 'test_expert_5', 'Gold', 95, 'active', now(), now()),
  ('66666666-6666-6666-6666-666666666666', 'pubkey:test6', 'test_expert_6', 'Silver', 72, 'active', now(), now()),
  ('77777777-7777-7777-7777-777777777777', 'pubkey:test7', 'test_expert_7', 'Silver', 80, 'active', now(), now())
